...
//using namespace cv;
//
//Mat pixelToTransparency(cv::Mat input, int r, int g, int b);
//
...
//int main()
//{
//	VideoCapture video("source.mp4"); // video source
//
//	if (!video.isOpened())
//	{
...
//	//int RECT_X = 844;
//	//int RECT_Y = 477;
//	int RECT_X = (int)video.get(CAP_PROP_FRAME_WIDTH);
//	int RECT_Y = (int)video.get(CAP_PROP_FRAME_HEIGHT);
//
//	Rect rect(Point(0, 0), Point(RECT_X, RECT_Y));
//	Rect rect1(Point(0, 0), Point(RECT_X*0.7, RECT_Y));
//	Rect rect2(Point(0, 0), Point(RECT_X, RECT_Y));
...
//	imwrite("theFramesL.jpg", theFrames);
//	Stitcher s1 = Stitcher::createDefault();
//	s1.stitch(leftFrames, leftEyeResult);
//	imwrite("leftEyeResult.jpg", leftEyeResult);
//	cv::Mat leftEye = leftEyeResult; // load as color image BGR
//	imwrite("Left Eye After Transparency.png", pixelToTransparency(leftEye, 0, 0, 0)); // save as .png file (which supports alpha channels/transparency)
//
//	hconcat(rightEyeResult, theFrames);
//	imwrite("theFramesR.jpg", theFrames);
//	Stitcher s2 = Stitcher::createDefault();
//	s2.stitch(rightFrames, rightEyeResult);
//	imwrite("rightEyeResult.jpg", rightEyeResult);
//	cv::Mat rightEye = rightEyeResult; // load as color image BGR
//	imwrite("Right Eye After Transparency.png", pixelToTransparency(rightEye, 0, 0, 0)); // save as .png file (which supports alpha channels/transparency)
//}
//
